                ...
                for (var a = 0; a < allkeys.length; a++) {
                    ...
                    for (var b = 0; b < allUserLeaves.length; b++) {
                        ...
                        if (row.status == 'Cancelled Request') {
                            leaveListCancel = leaveListCancel + (b + 1) + ') ' + myKey + ' ' + leaveFrom + ' to: ' + leaveTo + '\n';
                        } else if (row.status == 'Pending') {
                            leaveListPending = leaveListPending + (b + 1) + ') ' + myKey + ' ' + leaveFrom + ' to: ' + leaveTo + '\n';
                        } else if (row.status == 'Approved') {
                            leaveListApprove = leaveListApprove + (b + 1) + ') ' + myKey + ' ' + leaveFrom + ' to: ' + leaveTo + '\n';
                        }
                    }
                }
                async.parallel([
